Онлайн демо-версия https://github.com/maker27/wg_forge_frontend
...
JavaScript-код, реализующий вывод данных, должен быть реализован в файле `src/App.tsx` - это входная точка вашего приложения. Дальнейшая структура приложения - на ваше усмотрение.
